...
A tiny TeamGaga bot demo for beginners, built for the [getting started guide](https://open.teamgaga.com/docs/quick-overview/getting-started). It uses `@teamgaga/open-api` to poll channel messages and replies to `roll` with a dice result.
